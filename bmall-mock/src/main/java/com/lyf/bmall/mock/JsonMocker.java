package com.lyf.bmall.mock;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.lyf.bmall.mock.utils.*;
import com.lyf.bmall.mock.utils.RandomDate;
...
public class JsonMocker {
    ...
    /*RanOpt[] eventOpts= {new RanOpt("addFavor",10),new RanOpt("addComment",10),
            new RanOpt("addCart",10), new RanOpt("clickItem",10),
            new RanOpt("coupon",10)
    };*/
    ...
    public static void genLog() {
        ...
        for (int i = 0; i < jsonMocker.startupNum; i++) {
            String startupLog = jsonMocker.initStartupLog();  //返回一个json串
            //System.out.println("启动:"+startupLog);
            ...
            while (!jsonMocker.isQuitGroup.getRandomOpt().getValue()) {
                ...
                //System.out.println("事件:"+eventLog);
